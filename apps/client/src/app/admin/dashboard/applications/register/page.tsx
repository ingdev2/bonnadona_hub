...
import RegisterApplicationContent from "@/components/admin/all_applications/register_application/RegisterApplicationContent";
...
const RegisterApplicationPage = () => {
  ...
  usePermissionsAppAndModuleValidationInPage({
    ...
    allowedModules: [ApplicationModulesEnum.BONNA_HUB_APPLICATIONS_AND_MODULES],
  });
  ...
  return (
    <div className="home-page">
      ...
      {!idNumberUserSessionState || status === "unauthenticated" ? (
        ...
        <div className="dashboard-register-application-content">
          <RegisterApplicationContent />
        </div>
      )}
    </div>
  );
